...
**Last updated:** 2026-08-05 (Wiki title wrap + Overhead meta strip)
...
```powershell
test\run_tests.bat              # client unit tests only (405 tests)
```

From repo root (bridge + client):

```powershell
..\run_all_tests.bat            # bridge + client (405 client)
```
