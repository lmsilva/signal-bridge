...
- 2026-07-06: **Broadcast targeting fix** — `"broadcast to office echo this is a test"` and two-step `"announce to office echo"` → `"this is a test"` now split device vs message correctly (no more message `"echo"` or missed inline broadcasts).
